...
public class BlockConveyerContainer extends Container {

        protected TileEntityConveyer tileEntity;

        public BlockConveyerContainer (InventoryPlayer inventoryPlayer, TileEntityConveyer te){
                tileEntity = te;
